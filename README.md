...
An end-to-end Enterprise Business Intelligence solution developed using **SQL Server** and **Microsoft Power BI** to analyze airline operations, passenger satisfaction, and business performance.
...
`Power BI` • `SQL Server` • `DAX` • `Power Query` • `ETL` • `Star Schema`
